  ...
  return (
    <nav>
      <ul className="flex gap-2">
        <li>
          <Link href="/"
          className="px-4 py-4 font-poppins font-bold text-md tablet:text-base p-1 laptop:p-2 m-1 laptop:m-2 rounded-lg flex items-center transition-all ease-out duration-300 no-underline text-intellectual-grey"
          >Home</Link>
        </li>
